...
PIPELINE_NAME = 'campus-selection-pipeline'

# pipeline inputs
DATA_ROOT = 'data'
TRANSFORM_MODULE_FILE = 'modules/campus_selection_transform.py'
TRAINER_MODULE_FILE = 'modules/campus_selection_trainer.py'
